...
def run_backtest_csv(historical_csv_path: str):
    """
    ...
    try:
        ...
        if 'timestamp' not in df.columns:
            ...
            return
        df['timestamp'] = pd.to_datetime(df['timestamp'], unit='ms', errors='coerce') # Agar timestamp millisekundlarda bo'lsa
...
def run_backtest_tick_level(tick_data_csv_path: str):
    """
